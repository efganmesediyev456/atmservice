...
<script src="{{asset('admin/dist/plugins/datatables-buttons/js/dataTables.buttons.min.js')}}"></script>
<script src="{{asset('admin/dist/plugins/datatables-buttons/js/buttons.bootstrap4.min.js')}}"></script>
<script src="{{asset('admin/dist/plugins/jszip/jszip.min.js')}}"></script>
<script src="{{asset('admin/dist/plugins/pdfmake/pdfmake.min.js')}}"></script>
<script src="{{asset('admin/dist/plugins/pdfmake/vfs_fonts.js')}}"></script>
<script src="{{asset('admin/dist/plugins/datatables-buttons/js/buttons.html5.min.js')}}"></script>
<script src="{{asset('admin/dist/plugins/datatables-buttons/js/buttons.print.min.js')}}"></script>
<script src="{{asset('admin/dist/plugins/datatables-buttons/js/buttons.colVis.min.js')}}"></script>
